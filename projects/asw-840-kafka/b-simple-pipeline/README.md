...
Per eseguire l'applicazione (dopo la *Preparazione*), vanno utilizzate tre (o più) finestre (terminali) diverse: una per il **consumatore**, una per il **filtro** e una per il **produttore**. 
