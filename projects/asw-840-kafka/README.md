...
Queste applicazioni sono tutte composte da due o più componenti eseguibili (ad esempio, un componente produttore, un componente filtro e un componente consumatore). 
