...
docker run --name ricette-seguite-mysql -e MYSQL_USER=username -e MYSQL_PASSWORD=password -e MYSQL_ROOT_PASSWORD=password -e MYSQL_DATABASE=ricette_seguite -p 3309:3306 -d mysql:8.0