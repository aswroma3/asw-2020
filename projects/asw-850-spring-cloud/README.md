...
* [c-sentence-discovery-service](c-sentence-discovery-service/): uso di un servizio di service discovery: [Consul](https://www.consul.io/) e [Spring Cloud Consul](https://spring.io/projects/spring-cloud-consul) 

* [d-sentence-load-balancer](d-sentence-load-balancer/): uso di un load balancer lato client: [Spring Cloud LoadBalancer](https://spring.io/guides/gs/spring-cloud-loadbalancer/)

* [e-sentence-declarative-rest-client](e-sentence-declarative-rest-client/): uso di un client REST dichiarativo: [Spring Cloud OpenFeign](https://spring.io/projects/spring-cloud-openfeign)

* [f-sentence-circuit-breaker](f-sentence-circuit-breaker/): uso di un circuit breaker: [Spring Cloud Circuit Breaker](https://spring.io/projects/spring-cloud-circuitbreaker) e [Resilience4J](https://github.com/resilience4j/resilience4j)

* [g-sentence-apigateway](g-sentence-apigateway/): uso di un API gateway: [Spring Cloud Gateway](https://spring.io/projects/spring-cloud-gateway)

* [h-sentence-apigateway-async](h-sentence-apigateway-async/): uso di chiamate REST asincrone e concorrenti 
...
**Attenzione**: lo script `stop-java-processes.sh` fa il `pkill` di tutti i processi Java in esecuzione. 
