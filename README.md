...
* inoltre, alcuni ambienti di esecuzione sono basati sui contenitori [Docker](https://www.docker.com/)
  e l'orchestratore di contenitori [Kubernetes](https://kubernetes.io/)
